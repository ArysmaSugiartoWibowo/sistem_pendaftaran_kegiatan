            ...
            <div class="col-12">
                <div class="card card-success">
                    <div class="card-header">
                        <h3 class="card-title">Register Penjabat Komitmen Anggaran</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                    <form action="<?= site_url('bendahara/ControllerBendahara/register_action') ?>" method="post">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                <input type="hidden" id="level" name="level" class="form-control" value="ppkn" readonly>

...
<div class="modal fade" id="activateLpj" tabindex="-1" role="dialog" aria-labelledby="activateModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?php echo site_url('bendahara/ControllerBendahara/respon_lpj'); ?>" method="post" enctype="multipart/form-data">
                <div class="modal-header">
                    <h5 class="modal-title" id="activateModalLabel">Upload Kwitansi Pembayaran (PDF)</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="kwitansi_bendahara">Upload Kwitansi Pembayaran (PDF)</label>
                        <input type="file" name="kwitansi_bendahara" id="kwitansi_bendahara" class="form-control" accept=".pdf" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
...
<div class="modal fade" id="modalTolakLpj" tabindex="-1" role="dialog" aria-labelledby="activateModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?php echo site_url('bendahara/ControllerBendahara/tolak_lpj'); ?>" method="post" enctype="multipart/form-data">
                <div class="modal-header">
